...
* `ARRAY`: [array](array.md#constructor)
...
* `CEIL`: [decimal](decimal.md#ceil), [float](float.md#ceil), [datetime](datetime.md#date_ceil), [datetime](datetime.md#timestamp_ceil), [datetime](datetime.md#time_ceil)
...
* `DIV_NULL`: [integer](integer.md#div_null), [decimal](decimal.md#div_null), [float](float.md#div_null)
...
* `FINITE_OR_NULL`: [float](float.md#finite_or_null)
